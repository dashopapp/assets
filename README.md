...
[![Latest Version](https://img.shields.io/github/release/dashopapp/laravel-assets.svg?style=flat-square)](https://github.com/dashopapp/laravel-assets/releases)
[![Software License](https://img.shields.io/badge/license-MIT-brightgreen.svg?style=flat-square)](LICENSE.md)
[![Quality Score](https://img.shields.io/scrutinizer/g/dashopapp/laravel-assets.svg?style=flat-square)](https://scrutinizer-ci.com/g/dashopapp/laravel-assets)
[![StyleCI](https://styleci.io/repos/154250020/shield)](https://styleci.io/repos/154250020)
[![Total Downloads](https://img.shields.io/packagist/dt/dashopapp/assets.svg?style=flat-square)](https://packagist.org/packages/dashopapp/assets)
[![Maintainability](https://api.codeclimate.com/v1/badges/a6e4612307e3b3bf8252/maintainability)](https://codeclimate.com/github/dashopapp/laravel-assets/maintainability)

## Installation

```bash
composer require dashopapp/assets
```
...
'providers' => [
    ...
    Dashopapp\Assets\Providers\AssetsServiceProvider::class,
];
```
...
'aliases' => [
    ...
    'Assets' => Dashopapp\Assets\Facades\AssetsFacade::class,
];
```
...
```bash
php artisan vendor:publish --provider="Dashopapp\Assets\Providers\AssetsServiceProvider" --tag=config
```
